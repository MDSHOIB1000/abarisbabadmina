...
function AdminHeader({ handleClick, toggleSidebar, handleMenuClick, profileOn, profileOf, toggle }) {
    ...
    return (
        <>
                            ...
                            >
                                <div className="header-info2 d-flex align-items-center">
                                    ...
                                    <div className="header-info">
                                        <p className="text-light">{data?.refer_id}</p>
            ...
            {["end"].map((placement, idx) => (
                <NotificationSide key={idx} placement={placement} name={placement} handleClose={handleClose} show={show} NotificationData={NotificationData} />
            ))}
