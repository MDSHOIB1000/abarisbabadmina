...
function AdharPayMain({ title_1, title_2, title }) {
  ...
  return (
    ...
    {loading && <Loadar />}
      ...
      <AdharPayFilter title={title} initialValues={initialValues} userData={userData} submitForm={submitForm} aepsData={aepsData} />
      <AdharPayList title={title} onChangeVal={onChangeVal} aepsData={aepsData} getDmtTxnData={getDmtTxnData} />
    </>
  )
}
