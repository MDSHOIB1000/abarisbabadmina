                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 aabc">
                                    <div className="left-side-section">
                                        <div>Shop Name : <span>{data?.invoice[0]?.shop_name}</span></div>
                                ...
                                <div className="col-lg-6 aabc">
                                    <div className="right-side-section">
                                        ...
                                        <div>Date : <span>{new Date(data?.invoice[0]?.createdAt).getDate() + "/" + Number(new Date(data?.invoice[0]?.createdAt).getMonth() + 1) + "/" + new Date(data?.invoice[0]?.createdAt).getFullYear() + "," + new Date(data?.invoice[0]?.createdAt).getHours() + ":" + new Date(data?.invoice[0]?.createdAt).getMinutes()}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
