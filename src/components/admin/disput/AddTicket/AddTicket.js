                    ...
                    <div className="card-body">
                        <form action="" method="post" name="frmReport" id="frmReport">
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                ...
                                <div className="form-group col-md-4">
                                    <label>&nbsp;</label>
                                    <button type="button" style={{ width: '100%' }} disabled={!initialData.subject || !editor.current.value || !initialData.priority || !initialData.type || !initialData.service_id} className="btn btn-primary mr-3" onClick={submitData}>Submit</button>
                                </div>

                                {listImage && listImage?.map((item) => {
                                    return <div className="col-lg-3 img-shoe-set" key={item?.id} style={{ height: '155px' }}>
