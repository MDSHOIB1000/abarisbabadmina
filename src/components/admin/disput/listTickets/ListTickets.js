                        ...
                        <form action="" method="post" name="frmReport" id="frmReport">
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                ...
                                <div className="form-group col-md-4">
                                    ...
                                    <input type="text" name="end_date" id="account_no" className="form-control" placeholder="Enter Ticket Number" />
                                </div>
                                <div className="form-group col-md-4">
                                ...
                                <div className="form-group col-md-4">
                                    ...
                                    <select class="form-select" name="type" >
                                        ...
                                        <option value="debit">Success</option>
                                    </select>
                                </div>
                                    ...
                                    <tbody>
                                        {data && data?.map((item) => {
                                            ...
                                            return <tr className="odd" key={item?._id}>
                                                ...
                                                <td valign="top" className="dataTables_empty">{item?.status == 'Pendings' ? <button type="button" class="btn btn-warning">{item?.status}</button> : ' '}</td>
