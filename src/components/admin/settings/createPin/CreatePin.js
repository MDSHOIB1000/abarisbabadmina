...
function CreatePin() {
    ...
    return (
        <>
                    ...
                    <div className="card-body">
                        <form action="">
                            ...
                            <div className="text-align-center">
                                <button type="button" disabled={!initialData.oldPin || !initialData.newPin || !initialData.confirmPin} className="btn btn-primary" onClick={submitData}>
                                    Submit
            ...
            <ForgetPin handleClose={handleClose} show={show} toastSuccessMessage={toastSuccessMessage} />
            <ToastContainer />
        </>
    )
}
