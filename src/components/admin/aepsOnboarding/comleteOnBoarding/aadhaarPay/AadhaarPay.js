                    ...
                    <form action="" method="post" name="frmReport" id="frmReport">
                        ...
                        <div className="form-row" style={{ alignItems: 'end' }}>
                            ...
                            <div className="form-group col-md-12 text-align-center">
                                <label>&nbsp;</label>
                                {/* <Link to="/aeps-OnBoarded" className="btn btn-warning mr-2">
                                    Back
                                </Link> */}
                                <button type="button" className="btn btn-primary mr-3" disabled={!initialValue.mobilenumber || !initialValue.adhaarnumber || !showBanak?.iinno || !dataCapture || !initialValue.amount} onClick={submitData}>
                                    Proceed
                                </button>
                            </div>
