...
import { BENEFICIARYAdd, bankListApi, chargeBeneficiay, verificationBank } from "../../../../api/login/Login"
...
function AddNewBeneficiary(props) {
    ...
    useEffect(() => {
        ...
        // chargesBeneficiary()
        if (!initialValue.recipient_name || !initialValue.ifsc || !initialValue.account_number || !showBanak.bankID) {
            setVerifydisable(true)
        } else {
                ...
                <Modal.Body>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12">
                            {props.settingState && <p style={{ color: 'green', fontWeight: '500' }}> Account Verification Charge : ₹ {props.settingState} </p>}
                            <div className="addBneButton">
                                <div className="form-group text-align-center">
                                    <button type="button" disabled={verifydisable} className="btn btn-info" onClick={verifideBank}>
                                ...
                                <div className="form-group text-align-center">
                                    <button type="button" disabled={!initialValue.recipient_name || !showBanak?.bankID || !initialValue.ifsc || !initialValue.account_number} className="btn btn-info" onClick={HandleSubmitBeneficiary}>
