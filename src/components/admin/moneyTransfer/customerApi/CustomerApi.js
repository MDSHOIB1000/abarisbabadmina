...
function CustomerApi({ data, beneficiaryData, customerNumber, deleteRecipt, toastSuccessMessage, confirm, cancel, updateRecipetList, settingState, initialCustomer, toastSuccessMessageError, SubmitCustomer }) {
                                        ...
                                        return <div className="banck-sec">
                                            <div className="back-details">
                                                ...
                                                <div className="banckCustomer-delete">
                                                    {item?.isVerified == true ? <p style={{ color: 'green' }}>Verified <IoIosCheckbox style={{ fontSize: '22px' }} /></p> : <>
