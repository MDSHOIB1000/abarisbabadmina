                        ...
                        <div className="row">
                            <div className="col-md-12 col-sm-12">
                                ...
                                <div className="row form-group">
                                    ...
                                    {props?.initialCustomer.api_id == "Paysprint" ? <>
                                        <div className="col-lg-6">
                                            <div className="form-group">
                                                <div className="fl-wrap fl-wrap-input">
                                                    <label htmlFor="otp" className="fl-label">OTP <span style={{ color: 'red' }}>*</span></label>
                                                    <input type="number" className="form-control fl-input" id="otp" name="otp" value={defalutValue.otp} placeholder="Enter OTP" onChange={handleChange} />
                                                </div>
                                            </div>
                                        </div>
                                    </> : ''}
