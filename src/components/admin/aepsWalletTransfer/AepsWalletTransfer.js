                    ...
                    <div className="row row-row" id="dev-search-form">
                        <div className="col-md-4 ">
                            <div className="form-group mobile-input-container">
                                ...
                                <input type="number" id="txtSM" className="form-control" name="amount" value={initialVal.amount} placeholder="Enter Number" onChange={handleTrasfer} />
                        ...
                        <div className="col-md-3 pt-md-3 mt-1">
                            <button type="button" id="btnSearch" className="btn btn-success custom-button example-1" disabled={!initialVal.amount} onClick={SubmitTransfer}>
                                Submit
