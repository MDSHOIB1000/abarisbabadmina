...
function BuildingMasterList({ data, page, count, cancel, confirm, loading }) {
    return (
        <>
                                    ...
                                    <tbody>
                                        {data?.data?.map((item, i) => {
                                            return <tr role="row" className="odd">
                                                ...
                                                <td>
                                                    <span className="badge badge-success text-light border-0" style={{ backgroundColor: `${item?.isActive === true ? 'blue' : '#bc3922ab'}`, fontSize: `${item?.isActive === false ? '0.8rem' : ''}` }}>{item?.isActive == true ? 'varified'.toUpperCase() : 'un varified'.toUpperCase()}</span>
                                                </td>
                                                <td>
