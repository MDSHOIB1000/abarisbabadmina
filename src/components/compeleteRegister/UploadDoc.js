...
export const UploadDoc = ({ setState, docs, setModalShow }) => {
  ...
  return (
    <div className="container">
      ...
      <p style={{ margin: "15px 0", textAlign: "center" }}>
        Please upload all required documents. Ensure the copies are clear and
        legible.
      </p>
      ...
      <form className="row">
        ...
        <div className="form-group col-6">
          <label htmlFor="bankProof">
            Please upload a photo of the shop's interior:
          </label>
          <input
            type="file"
            className="form-control"
        ...
        >
          ...
          {btnDisable && (
            <button
              ...
              disabled={btnDisable}
              className={`${
                btnDisable ? "btn btn-info not-allowed" : "btn btn-info"
              } text-white`}
            >
              Next
            </button>
